...
// Singleton para garantir apenas uma inicialização
let app: FirebaseApp;
let auth: Auth;
let db: Firestore;
...
if (!getApps().length) {
    ...
    // Inicialização do Auth com persistência no AsyncStorage
    // Isso é CRUCIAL para manter o usuário logado após fechar o app
